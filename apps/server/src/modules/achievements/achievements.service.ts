...
const ACHIEVEMENT_DEFINITIONS = [
  { key: "first_chore",       name: "First Steps",          descriptionKey: "achievement.first_chore.description",       category: "milestone",      isRepeatable: false, goal: 1,    bonusPoints: 10,  sortOrder: 0 },
  { key: "streak_5",          name: "On a Roll",            descriptionKey: "achievement.streak_5.description",           category: "streak",         isRepeatable: false, goal: 5,    bonusPoints: 15,  sortOrder: 10 },
  { key: "streak_25",         name: "Habit Formed",         descriptionKey: "achievement.streak_25.description",          category: "streak",         isRepeatable: false, goal: 25,   bonusPoints: 50,  sortOrder: 11 },
  { key: "streak_50",         name: "Unstoppable",          descriptionKey: "achievement.streak_50.description",          category: "streak",         isRepeatable: true,  goal: 50,   bonusPoints: 100, sortOrder: 12 },
  { key: "perfect_day",       name: "Perfect Day",          descriptionKey: "achievement.perfect_day.description",        category: "consistency",    isRepeatable: true,  goal: 1,    bonusPoints: 5,   sortOrder: 20 },
  { key: "perfect_week",      name: "Flawless Week",        descriptionKey: "achievement.perfect_week.description",       category: "consistency",    isRepeatable: true,  goal: 7,    bonusPoints: 25,  sortOrder: 21 },
  { key: "points_100",        name: "Century",              descriptionKey: "achievement.points_100.description",         category: "points",         isRepeatable: false, goal: 100,  bonusPoints: 0,   sortOrder: 30 },
  { key: "points_500",        name: "High Scorer",          descriptionKey: "achievement.points_500.description",         category: "points",         isRepeatable: false, goal: 500,  bonusPoints: 0,   sortOrder: 31 },
  { key: "points_1000",       name: "Points Legend",        descriptionKey: "achievement.points_1000.description",        category: "points",         isRepeatable: false, goal: 1000, bonusPoints: 0,   sortOrder: 32 },
  { key: "hard_chore_5",      name: "Tough Tackler",        descriptionKey: "achievement.hard_chore_5.description",       category: "difficulty",     isRepeatable: false, goal: 5,    bonusPoints: 20,  sortOrder: 40 },
  { key: "hard_chore_25",     name: "Chore Champion",       descriptionKey: "achievement.hard_chore_25.description",      category: "difficulty",     isRepeatable: false, goal: 25,   bonusPoints: 50,  sortOrder: 41 },
  { key: "multi_group_helper",name: "All-Rounder",          descriptionKey: "achievement.multi_group_helper.description", category: "collaboration",  isRepeatable: false, goal: 3,    bonusPoints: 30,  sortOrder: 50 }
] as const;
...
export class AchievementsService implements OnModuleInit {
  ...
  async evaluateForUser(input: AchievementEvalInput): Promise<UnlockedAchievement[]> {
    ...
    for (const achievement of achievements) {
      ...
      const newProgress = await this.computeProgress(achievement.key, input, user, current?.progress ?? 0);
