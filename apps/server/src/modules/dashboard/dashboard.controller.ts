...
export class DashboardController {
  ...
  async exportRuntimeLogsJson(
    ...
    response.setHeader(
      'Content-Disposition',
      'attachment; filename="taskbandit-runtime-logs.json"',
    );
  ...
  async exportHouseholdSnapshot(
    ...
    response.setHeader(
      'Content-Disposition',
      'attachment; filename="taskbandit-household-snapshot.json"',
    );
  ...
  async exportTenantManifest(
    ...
    response.setHeader(
      'Content-Disposition',
      'attachment; filename="taskbandit-tenant-export-manifest.json"',
    );
  ...
  async exportTenantDeletionManifest(
    ...
    response.setHeader(
      'Content-Disposition',
      'attachment; filename="taskbandit-tenant-deletion-manifest.json"',
    );
