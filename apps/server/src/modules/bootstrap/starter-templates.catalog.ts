...
export const starterTemplateCatalog: StarterCatalog = [
  // ── LAUNDRY ──────────────────────────────────────────────────────────────
  {
    ...
    checklist: [
      { title: { en: "Load the machine", de: "Maschine befüllen", hu: "Gép megtöltése" }, required: true },
      { title: { en: "Add detergent", de: "Waschmittel einfüllen", hu: "Mosószer hozzáadása" }, required: true },
      { title: { en: "Start the programme", de: "Programm starten", hu: "Program indítása" }, required: true }
    ],
  ...
  // ── KITCHEN ──────────────────────────────────────────────────────────────
  {
    ...
    title: { en: "Evening kitchen cleanup", de: "Küche abends aufräumen", hu: "Esti konyhatakarítás" },
    description: {
    ...
    checklist: [
      { title: { en: "Load and run the dishwasher", de: "Geschirrspüler befüllen und starten", hu: "Mosogatógép feltöltése és indítása" }, required: true },
      { title: { en: "Wipe the countertops", de: "Arbeitsflächen abwischen", hu: "Pultok letörlése" }, required: true },
      { title: { en: "Wipe the table", de: "Tisch abwischen", hu: "Asztal letörlése" }, required: true },
      { title: { en: "Wipe door handles", de: "Türgriffe abwischen", hu: "Kilincsek letörlése" }, required: false }
    ],
    followUps: [{ key: "kitchen_unload_dishwasher", delayValue: 8, delayUnit: FollowUpDelayUnit.HOURS }]
  },
  {
    key: "kitchen_unload_dishwasher",
    groupTitle: { en: "Kitchen", de: "Küche", hu: "Konyha" },
    title: { en: "Unload the dishwasher", de: "Geschirrspüler ausräumen", hu: "Mosogatógép kipakolása" },
    description: {
  ...
  },
  {
    ...
    groupTitle: { en: "Kitchen", de: "Küche", hu: "Konyha" },
    title: { en: "Clean the microwave", de: "Mikrowelle reinigen", hu: "Mikrohullámú sütő tisztítása" },
    description: {
    ...
    recurrenceStartStrategy: RecurrenceStartStrategy.COMPLETED_AT,
    checklist: [
      { title: { en: "Remove and clean the turntable", de: "Drehteller herausnehmen und reinigen", hu: "Forgótányér kivétele és tisztítása" }, required: true },
      { title: { en: "Wipe the inside", de: "Innenraum abwischen", hu: "Belső rész letörlése" }, required: true },
      { title: { en: "Wipe the outside", de: "Außenseite abwischen", hu: "Külső rész letörlése" }, required: false }
    ]
  },
  {
    ...
    recurrenceStartStrategy: RecurrenceStartStrategy.COMPLETED_AT,
    checklist: [
      { title: { en: "Discard expired items", de: "Abgelaufene Produkte entsorgen", hu: "Lejárt termékek kidobása" }, required: true },
      { title: { en: "Wipe shelves and drawers", de: "Regale und Schubladen abwischen", hu: "Polcok és fiókok letörlése" }, required: true },
      { title: { en: "Wipe door seals", de: "Türdichtungen abwischen", hu: "Ajtótömítések letörlése" }, required: false }
    ]
  },
  {
  ...
  },
  {
    ...
    recurrenceStartStrategy: RecurrenceStartStrategy.DUE_AT,
    checklist: [
      { title: { en: "Clean the sink", de: "Waschbecken reinigen", hu: "Mosdó tisztítása" }, required: true },
      { title: { en: "Clean the toilet", de: "Toilette reinigen", hu: "WC tisztítása" }, required: true },
      { title: { en: "Clean the shower or bath", de: "Dusche oder Badewanne reinigen", hu: "Zuhany vagy kád tisztítása" }, required: true },
      { title: { en: "Wipe the mirror", de: "Spiegel abwischen", hu: "Tükör letörlése" }, required: false },
      { title: { en: "Mop the floor", de: "Boden wischen", hu: "Padló felmosása" }, required: false }
    ]
  },
  {
    key: "cleaning_toilet",
  ...
  },
  {
    ...
    groupTitle: { en: "Cleaning", de: "Reinigung", hu: "Takarítás" },
    title: { en: "Tidy the living areas", de: "Wohnbereiche aufräumen", hu: "Nappali rendbe rakása" },
    description: {
  ...
  // ── WASTE & RECYCLING ─────────────────────────────────────────────────────
  {
    ...
    groupTitle: { en: "Waste & Recycling", de: "Müll & Recycling", hu: "Hulladék & Újrahasznosítás" },
  ...
  },
  {
    ...
    groupTitle: { en: "Waste & Recycling", de: "Müll & Recycling", hu: "Hulladék & Újrahasznosítás" },
    title: { en: "Take out the recycling", de: "Recycling rausbringen", hu: "Újrahasznosítható anyagok kivitele" },
    description: {
  ...
  },
  {
    ...
    recurrenceStartStrategy: RecurrenceStartStrategy.COMPLETED_AT,
    stickyFollowUpAssignee: true,
    followUps: [{ key: "bedroom_put_on_sheets", delayValue: 8, delayUnit: FollowUpDelayUnit.HOURS }]
  },
  {
    key: "bedroom_put_on_sheets",
    groupTitle: { en: "Bedroom", de: "Schlafzimmer", hu: "Hálószoba" },
    title: { en: "Put on fresh sheets", de: "Frische Bettwäsche beziehen", hu: "Friss ágynemű felhúzása" },
    description: {
