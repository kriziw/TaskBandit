...
export function createEmptyTemplateForm(defaultLocale: TemplateTranslationLocale): TemplateFormState {
  return {
    defaultLocale,
    groupTitle: "",
    title: "",
...
interface TemplateStore {
  ...
  setTemplateForm: (v: TemplateFormState | ((prev: TemplateFormState) => TemplateFormState)) => void;
