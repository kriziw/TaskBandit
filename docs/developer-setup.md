...
- The admin system status page exposes those effective log limits as read-only values, which makes it easy to confirm what the running container actually loaded from `.env`.
