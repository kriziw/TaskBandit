...
- if TaskBandit is behind a public HTTPS proxy, leave the simplified env model in place and only use the advanced CORS or reverse-proxy overrides when you intentionally need custom behavior
